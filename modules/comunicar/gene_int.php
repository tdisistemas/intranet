	...
	<div class="grid-17">
		...
		<div class="widget widget-table">
			<div class="widget-header">
				...
				<h3 class="icon chart">Comunicaciones Internas</h3>
			</div>
			<tr>
...
?>" method="POST" target="_blank" name="ddd" id="ddd">
    ...
    <br>
					...
					<div>
						...
						<?php
$sql1 = "SELECT CONCAT( nombre, ' ', apellido ,'-   ',cargo,'-',gerencia) AS nombre FROM datos_empleado_rrhh order by nombre";
...
?>
				...
				<div class="control-group">
   <div class="controls">
      <input id="de" name="de" type="hidden" placeholder="" class="input-large" size="42%" readonly value="<?php echo  $usuario_datos[1] . ' ' . $usuario_datos[2].'-'._damecargo($usuario_datos[3]); ?>" required="" />
  </div>
</div>
...
<!-- Text input-->
	...
	<br>
      ...
      <textarea name="texto" cols="100" rows="20"></textarea>
