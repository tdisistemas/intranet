  ...
  <div class="grid-24">	
		<div class="widget widget-table">
			<div class="widget-header">
				...
				<h3 class="icon chart">Registro de Proyectos Clase I</h3>		
				<span class="icon-folder-fill"></span>
				<h3 class="icon chart"><a href="dashboard.php?data=insertar_cl1" style="color: white;text-decoration: none;">Agregar Proyecto</a></h3>		
			</div>
			<div class="widget-content">
				<table class="table table-bordered table-striped data-table">
					...
					<tbody>
						...
						$sql=mysql_query("SELECT *FROM control_gestion WHERE clase='ClaseI'");
						...
						?>
                            <tr class="gradeA">
                                ...
                                <td class="center">
                                    ...
                                    ?>
                                    <a href="dashboard.php?data=seg_fase&flag=1&<?php echo $parametro; ?>" id="insertar" title="Insertar Segunda Fase" >
